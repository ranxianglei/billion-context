...
export default defineConfig({
    entry: ["src/index.ts", "src/mcp.ts", "src/agent/pi.ts", "src/agent/pi-native.ts", "src/agent/omp.ts", "src/agent/opencode.ts", "src/agent/opencode-native.ts", "src/agent/dsh-acp.ts"],
    format: ["esm"],
    target: "node20",
    platform: "node",
    outDir: "dist",
