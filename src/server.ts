...
import { adminPathMatches, handleAdminRequest } from "./server/admin.js";
export { selfAdminProbePath } from "./server/admin.js";
...
async function handle(
    ...
    if (await handleAdminRequest(req, res, opts, log, { instanceId, instanceStartedAt, proxyWatchers, initialWatcherPid })) return;
